...
function hotelStore(event){
  ...
  if (event.target.innerHTML === plan.planDays[0].planHotel.name){
    const myHotel = plan.planDays[0].planHotel;
    localStorage.setItem('renderme',JSON.stringify(myHotel));
    console.log(event);

  }
  if (event.target.innerHTML === plan.planDays[0].planResturent[0].name){
    const myRest = plan.planDays[0].planResturent[0];
    localStorage.setItem('renderme',JSON.stringify(myRest));
    console.log(event);

  }
  if (event.target.innerHTML === plan.planDays[0].planResturent[1].name){
    const myRest = plan.planDays[0].planResturent[1];
    localStorage.setItem('renderme',JSON.stringify(myRest));
    console.log(event);

  }
  if (event.target.innerHTML === plan.planDays[0].planActivities[0].name){
    const myRest = plan.planDays[0].planActivities[0];
    localStorage.setItem('renderme',JSON.stringify(myRest));
    console.log(event);

  }
  if (event.target.innerHTML === plan.planDays[0].planActivities[1].name){
    const myRest = plan.planDays[0].planActivities[1];
    localStorage.setItem('renderme',JSON.stringify(myRest));
    console.log(event);

  }
  if (event.target.innerHTML === plan.planDays[0].planActivities[2].name){
    const myRest = plan.planDays[0].planActivities[2];
    localStorage.setItem('renderme',JSON.stringify(myRest));
    console.log(event);
